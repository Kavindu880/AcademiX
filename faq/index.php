      ...
      <div class="container">
        <div class="faq">
          ...
          <div class="faq-item">
            ...
            <label for="faq1" class="faq-question">What is the Online Teacher Training System?</label>
          ...
          <div class="faq-item">
            ...
            <label for="faq2" class="faq-question">How can I sign up?</label>
            <div class="faq-answer">
              <p>
          ...
          <div class="faq-item">
            ...
            <label for="faq3" class="faq-question">What types of courses are available?</label>
            <div class="faq-answer">
              <p>
          ...
          <div class="faq-item">
            ...
            <label for="faq4" class="faq-question">How do I pay for a course?</label>
            <div class="faq-answer">
              <p>
          ...
          <div class="faq-item">
            ...
            <label for="faq5" class="faq-question">Will I get a certificate after completing a course?</label>
            <div class="faq-answer">
              <p>
          ...
          <div class="faq-item">
            ...
            <label for="faq6" class="faq-question">What if I face issues with the course?</label>
            <div class="faq-answer">
              <p>
